...
<html>
    ...
    <body>
        <div id="header">
            <div id="logo">
                <img src="hinhanh\logo.jpg" alt="Ch?a load logo" style=" width: 200px; height: 69px">
            </div>
            <div id="logomain">
                <h2> THƯ VIỆN SÁCH ONLINE  EBOOK FREE</h2>
        ...
        <div>
            ...
            <div id="container">
                ...
                <!--                <div class="phai">
                                    <img src="D:\nam 4\BT K1\LTM\BaiTap\web\DocSach\kynangsong\sachhan.jpg" alt="loading..." style="height: 400px;"><br>
                                    <a href = "#" > Giáo Trình Ti?ng Hàn C? B?n</a>
                                </div>
                                <div class="trai">
